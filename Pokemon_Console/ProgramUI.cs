...
namespace Pokemon_Console
{
    public class ProgramUI
    {
        ...
        {
            Pokemon pika = new Pokemon("Pikachu", "Pika(Nickname)", 1, PokemonType.Electric, PokemonType.None, "Sand Attack", "Growl", "Quick Attack", "Tackle");
